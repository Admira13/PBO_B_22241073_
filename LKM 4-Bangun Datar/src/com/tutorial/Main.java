...
class PersegiPanjang extends BangunDatar {
    ...
    public void display() {
        System.out.println("Panjang persegi panjang: " + panjang + " dan lebar: " + lebar);
    }
}
...
class Segitiga extends BangunDatar {
    ...
    public void display() {
        System.out.println("Alas segi tiga: " + alas + ", tinggi segi tiga: " + tinggi +
...
public class Main {
    public static void main(String[] args) {
        ...
        Lingkaran lingkaran = new Lingkaran(25.0f);
        lingkaran.display();
        ...
        PersegiPanjang persegiPanjang = new PersegiPanjang(12.0f, 14.0f);
        ...
        Segitiga segitiga = new Segitiga(4.0f, 5.0f, 6.0f, 5.0f, 4.0f);
        segitiga.display();
