...
public class Main {
    public static void main(String[] args) {
        Pegawai pegawai1 = new PegawaiTetap("Admira Sabtatil Yadaini", 2000000);
        Pegawai pegawai2 = new PegawaiTidakTetap("Astiti Sofyati Zahra", 900000);

        pegawai1.setTunjangan(70);
        pegawai1.setDurasiLembur(9);

        pegawai2.setDurasiLembur(6);
        pegawai1.display();
        pegawai2.display();
    }
}